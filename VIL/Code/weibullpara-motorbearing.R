...
plot(da1, main=paste("Motor Bearing - unbias"))
...
plot(survi(c(0:T),eta,beta),pch=14,axes=FALSE,ylim=c(0,1),ylab="", xlab="",col="red",type="l",lwd=2,cex=1, main=paste("pump motor bearing - unbias"))
#  par(new=TRUE)
...
box()
legend("topright",inset=.05,legend=c(paste("pump motor bearing - unbias ")), text.col="black",lty=c(1),col=colors[i], horiz=F,cex=0.8,bg = "gray90")
