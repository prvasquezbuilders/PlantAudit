...
plot(da1, main=paste("Coupling - bias"))
...
plot(survi(c(0:T),eta,beta),pch=14,axes=FALSE,ylim=c(0,1),ylab="", xlab="",col="red",type="l",lwd=2,cex=1, main=paste("Coupling - bias"))
#  par(new=TRUE)
...
box()
legend("topright",inset=.05,legend=c(paste("Coupling - bias ")), text.col="black",lty=c(1),col=colors[i], horiz=F,cex=0.8,bg = "gray90")
