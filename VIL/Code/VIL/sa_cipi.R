...
#SA on alpha parameter
  ...
  for (k in 1:maxobj){
    ...
    png(filename=paste("E:/OP18REFCS03/Stations/PAG/Report/figures/ch05_fig_sacipi_pump",k,".png",sep=""),width = 800, height = 500)  
    ...
    mtext(expression(paste("Ratio (CI/PI)")),side=1,col="black",line=2.5)  
