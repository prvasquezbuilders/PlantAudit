...
%A simplest way to predict the remaining duration till thickness of pipe reaching alarming level (minimum allowable thickness). This prediction is shown in Figure \ref{ch04_thickness_predict}
