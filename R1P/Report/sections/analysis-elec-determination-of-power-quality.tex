...
\input{tables/tbl_ch04_elecaudit_powerquality_rms}
...
\input{tables/tbl_ch04_elecaudit_powerquality_voltageunbalance}
...
\input{tables/tbl_ch04_elecaudit_powerquality_currentunbalance}
...
\input{tables/tbl_ch04_elecaudit_powerquality_thdcompliance}
...
\input{tables/tbl_ch04_elecaudit_powerquality_tddcompliance}
...
\input{tables/tbl_ch04_elecaudit_powerquality_frequency}
...
\input{tables/tbl_ch04_elecaudit_powerquality_powerfactor}
...
\end{itemize}
%
\input{tables/tbl_ch04_elecaudit_powerquality_flicker}
...
\hline
A & 1.41 & 1.45 & 1.36 & 2.14 \\ 
B & 1.41 & 1.46 & 1.36 & 2.08 \\ 
C & 1.42 & 1.47 & 1.38 & 2.08 \\ 
\hline
\end{tabular}
...
\begin{tabular}{l|l|l|l|l}
	...
	\multicolumn{1}{c|}{phase} & MIN & MAX & MIN & MAX \\ 
	\hline
A & 1.41 & 1.46 & 1.53 & 5.18 \\ 
B & 1.41 & 1.62 & 1.62 & 6.29 \\ 
C & 1.42 & 1.47 & 1.55 & 6.07 \\ 
\hline
\end{tabular}

\begin{tabular}{l|l|l|l|l}
	\hline
	\multicolumn{1}{c|}{VFD-2} & \multicolumn{2}{c|}{VOLTAGE} & \multicolumn{2}{c}{CURRENT} \\ 
	\cline{2-5}
	\multicolumn{1}{c|}{phase} & MIN & MAX & MIN & MAX \\ 
	\hline
     A & 1.42 & 1.46 & 1.45 & 11.08 \\ 
B & 1.41 & 1.45 & 1.51 & 8.39 \\ 
C & 1.42 & 1.46 & 1.43 & 11.95 \\ 
	\hline
\end{tabular}
...
\begin{tabular}{l|l|l|l|l}
	...
	\hline
     A & 1.41 & 1.48 & 1.37 & 5.15 \\ 
B & 1.41 & 1.44 & 1.06 & 70.51 \\ 
C & 1.42 & 1.48 & 1.27 & 4.73 \\ 
	\hline
\end{tabular}
	
	\item Investigate TDD again on the low-voltage side of the transformer serving each  motor, and at the meter where utility service is being received, to get a better sense of how the distortion has perpetuated throughout the system. If distortion is high at the meter, investigate further by installing harmonic filtration equipment. An active filter (cancellation of all harmonics) can be considered altogether.
